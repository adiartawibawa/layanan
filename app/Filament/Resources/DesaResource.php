...
class DesaResource extends Resource
{
    ...
    protected static ?string $navigationGroup = 'Basis Data';
    ...
    public static function table(Table $table): Table
    {
        return $table
            ...
            ->actions([
                ...
                // Tables\Actions\Action::make('peta')
                //     ->label('')
                //     ->icon('heroicon-o-map')
                //     ->action(fn (Desa $record) => $record->advance())
                //     ->modalContent(fn (Desa $record): View  => view(
                //         'filament.pages.maps',
                //         ['record' => $record]
                //     ))
            ])
