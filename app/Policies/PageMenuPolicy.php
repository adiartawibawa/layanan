...
class PageMenuPolicy
{
    ...
    {
        return $user->can('delete_any_page::menu');
    }
    ...
    {
        return $user->can('force_delete_any_page::menu');
    }
    ...
    {
        return $user->can('restore_any_page::menu');
    }
     ...
     * @return bool
     */
    public function replicate(User $user, PageMenu $pageMenu): bool
    {
        return $user->can('replicate_page::menu');
    }
    ...
    {
        return $user->can('reorder_page::menu');
    }
