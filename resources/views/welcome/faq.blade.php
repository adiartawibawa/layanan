        ...
        <div class="-mx-4 flex flex-wrap">
            <div class="w-full px-4">
                <div class="mx-auto mb-[60px] max-w-[700px] text-center">
                    ...
                    <p class="mx-auto max-w-[685px] text-base text-body-color dark:text-dark-6">
                        Di sini, Anda akan menemukan jawaban untuk pertanyaan yang sering diajukan tentang layanan dan
                        kebijakan kami, dengan jawaban yang jelas dan mudah dipahami.
                    </p>
                </div>
            </div>
        </div>
