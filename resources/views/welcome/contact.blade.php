                ...
                <div class="ud-contact-content-wrapper">
                    <div class="ud-contact-title mb-12 lg:mb-[150px]">
                        ...
                        <h2 class="max-w-[460px] text-[35px] font-semibold leading-[1.14] text-dark dark:text-white">
                            Mari sampaikan keluhan layanan pendidikan di sekitar Anda.
                        </h2>
                        <p class="mt-4 text-base text-dark-4">
                            Kami selalu siap membantu dan mendukung kebutuhan pendidikan Anda. Jika Anda memiliki
                            pertanyaan, saran, atau membutuhkan informasi lebih lanjut, jangan ragu untuk menghubungi
