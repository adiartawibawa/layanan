        ...
        <div class="-mx-4 flex flex-wrap">
            <div class="w-full px-4">
                <div class="mx-auto mb-[60px] max-w-[485px] text-center">
                    <span class="mb-2 block text-lg uppercase font-semibold text-primary">
                        Tim Kami
                    </span>
                    <h2
                    ...
                    <p class="text-base text-body-color dark:text-dark-6">
                        Anda dapat mengenal lebih jauh tentang struktur tim kami yang berdedikasi untuk memberikan
            ...
            <div class="w-full px-4 sm:w-1/2 lg:w-1/4 xl:w-1/4">
                <div
                    ...
                    <div class="relative z-10 mx-auto mb-5 h-[120px] w-[120px]">
                        <img src="./images/team/team-01.png" alt="team image"
