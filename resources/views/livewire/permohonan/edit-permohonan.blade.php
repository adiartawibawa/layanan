<div>
    <x-slot name="header">
        <h1 class="text-2xl font-semibold text-slate-600">Perbaikan Permohonan Layanan</h1>
        <p class="text-sm font-normal">
            Perbaikilah permohonan yang telah Anda buat sebelumnya, agar dapat mengajukan permohonan layanan
            {{ $permohonan->layanan->nama }} kembali.
        </p>
    </x-slot>
