...
<footer class="wow fadeInUp relative z-10 bg-[#090E34] pt-20 lg:pt-[100px]" data-wow-delay=".15s">
    <div class="container">
        <div class="-mx-4 flex flex-wrap">
            <div class="w-full px-4 sm:w-1/2 md:w-1/2 lg:w-4/12 xl:w-3/12">
                <div class="mb-10 w-full">
                    <a href="javascript:void(0)" class="mb-6 inline-block max-w-[160px]">
                        <div
                            class="max-w-full font-caveat text-white text-2xl font-medium lg:group-hover:text-white lg:group-hover:opacity-70 ">
                            {{ $meta['app_name'] }}
                        </div>
                    </a>
                    ...
                    <a href="mailto:{{ $meta['app_mail'] }}"
                        class="mb-2 max-w-[270px] text-sm text-gray-7 inline-flex space-x-2 justify-items-center">
                        ...
                        <span>{{ $meta['app_mail'] }}</span>
                    </a>
                    <p class="mb-8 max-w-[270px] text-sm text-gray-7 inline-flex space-x-2 justify-items-center">
                        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" class="w-5 h-5">
                            <path fill-rule="evenodd"
                                d="M1.5 4.5a3 3 0 0 1 3-3h1.372c.86 0 1.61.586 1.819 1.42l1.105 4.423a1.875 1.875 0 0 1-.694 1.955l-1.293.97c-.135.101-.164.249-.126.352a11.285 11.285 0 0 0 6.697 6.697c.103.038.25.009.352-.126l.97-1.293a1.875 1.875 0 0 1 1.955-.694l4.423 1.105c.834.209 1.42.959 1.42 1.82V19.5a3 3 0 0 1-3 3h-2.25C8.552 22.5 1.5 15.448 1.5 6.75V4.5Z"
                                clip-rule="evenodd" />
                        </svg>
                        <span>{{ $meta['app_phone'] }}</span>
                    </p>
            ...
            <div class="w-full px-4 sm:w-1/2 md:w-1/2 lg:w-3/12 xl:w-2/12">
                <div class="mb-10 w-full">
                    <h4 class="mb-9 text-lg font-semibold text-white">Data Kita</h4>
                    <ul>
                        <li>
                ...
                <div class="w-full px-4 md:w-1/3 lg:w-1/2">
                    <div class="my-1 flex justify-center md:justify-end">
                        <p class="text-base text-gray-7">
                            Made with ❤️ by
                            <a href="wa.me/+6281916175060" rel="nofollow noopner" target="_blank"
