        ...
        <div class="relative -mx-4 flex items-center justify-between">
            <div class="w-64 max-w-full px-4">
                <a href="{{ route('welcome') }}" class="navbar-logo w-full py-5 inline-flex items-center">
                    ...
                    <div
                        class="ml-2 font-caveat text-white text-xl font-medium header-text lg:group-hover:text-white lg:group-hover:opacity-70 ">
                        Disdikpora Badung
                    </div>
                </a>
            </div>
                    ...
                    <nav id="navbarCollapse"
                        ...
                        <ul class="blcok lg:flex 2xl:ml-20">
                            ...
                            <li class="submenu-item group relative">
                                ...
                                <div
                                    class="relative left-0 top-full hidden w-[250px] rounded-sm bg-white p-4 transition-[top] duration-300 group-hover:opacity-100 dark:bg-dark-2 lg:invisible lg:absolute lg:top-[110%] lg:block lg:opacity-0 lg:shadow-lg lg:group-hover:visible lg:group-hover:top-full">
                                    ...
                                    <a href="#berita"
                                        class="block ud-menu-scroll rounded px-4 py-[10px] text-sm text-body-color hover:text-primary dark:text-dark-6 dark:hover:text-primary">
                                        Berita
                                    </a>
                                    <a href="#testimonials"
                                        class="block ud-menu-scroll rounded px-4 py-[10px] text-sm text-body-color hover:text-primary dark:text-dark-6 dark:hover:text-primary">
                    ...
                    <div class="hidden sm:flex">
                        @auth
                            <a href="{{ url('dashboard') }}"
                                class="signUpBtn rounded-md bg-white bg-opacity-20 ml-6 px-6 py-2 text-base font-medium text-white duration-300 ease-in-out hover:bg-opacity-100 hover:text-dark">
                                Dashboard
                            </a>
                        @else
                            <a href="{{ url('login') }}"
