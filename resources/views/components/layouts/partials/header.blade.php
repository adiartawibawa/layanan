<header class="z-40 items-center w-full h-16 bg-white shadow-lg dark:bg-gray-700 md:rounded-md">
    <div class="relative z-20 flex flex-col justify-center h-full pl-2 mx-auto flex-center">
        <div class="relative flex items-center w-full lg:max-w-68 sm:pr-2 sm:ml-0 py-4">
            ...
            <div class="flex items-center justify-end w-1/4 p-1 ml-5 mr-4 sm:mr-0 sm:right-auto">
                @livewire('notification.panel-notification')
                ...
                <div x-data="{ isOpen: true }" class="relative">
                    ...
                    <div x-cloak x-show="!isOpen" @click.away="isOpen = true"
                        ...
                        <a href="{{ route('user-profile-information.update') }}" type="PUT"
